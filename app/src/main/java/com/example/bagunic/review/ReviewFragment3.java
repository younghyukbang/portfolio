...
public class ReviewFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.reviewfragment3, container, false);
    ...
    private void setData1(HashMap<String,Integer> dataHash1) {
        ...
        int[] icons = {R.drawable.ee, R.drawable.dd,
                R.drawable.cc, R.drawable.bb,
                R.drawable.aa};
